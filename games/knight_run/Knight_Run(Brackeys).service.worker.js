...
/** @type {string} */
const CACHE_VERSION = '1772051835|1036385951';
/** @type {string} */
const CACHE_PREFIX = 'Knight_Run(Brack-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Knight_Run(Brackeys).offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Knight_Run(Brackeys).html","Knight_Run(Brackeys).js","Knight_Run(Brackeys).offline.html","Knight_Run(Brackeys).icon.png","Knight_Run(Brackeys).apple-touch-icon.png","Knight_Run(Brackeys).audio.worklet.js","Knight_Run(Brackeys).audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Knight_Run(Brackeys).wasm","Knight_Run(Brackeys).pck"];
